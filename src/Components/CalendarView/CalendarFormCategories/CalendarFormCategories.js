...
import * as style from './CalendarFormCategories.module.scss';

const CalendarFormCategories = ({ handleCategoriesRadioInputChange }) => {
  return (
    <div className={style.category}>
      <h3 className={style.category__title}>Category</h3>
...
export default CalendarFormCategories;

CalendarFormCategories.propTypes = {
